    ...
    <section style={{ background: S950, paddingTop: "7rem", paddingBottom: "5rem",
      ...
      <div style={{ maxWidth: 840, margin: "0 auto", padding: "0 2rem", position: "relative" }}>
        ...
        <h1 className="hero-h1 fu d1" style={{
          ...
          <span className="grad-text">Flat rate. No exception billing.</span>
        </h1>
        ...
        <div className="fu d4" style={{ marginTop: "3.5rem",
          ...
          {[
            { v: "Volume",  l: "tiered per claim rate" },
      ...
      <div ref={ref} style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <div className="rv" style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "rgba(255,255,255,.45)", fontSize: ".93rem",
            ...
            Flat per claim rate. No exception billing. No hidden fees. Pricing scales with your volume — book a call and we'll build the right structure for your program.
          </p>
        </div>
        ...
        <div className="rv td1 pcols" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", marginBottom: "1.25rem" }}>
          ...
          <div style={{ border: "1px solid rgba(255,255,255,.1)", borderRadius: "1.25rem",
            ...
            <div style={{ fontSize: "1.35rem", fontWeight: 900, color: CYAN,
              letterSpacing: "-.03em", lineHeight: 1, marginBottom: ".2rem" }}>No Platform Fee</div>
            <div style={{ fontSize: ".82rem", color: "#64748b" }}>Flat per claim rate · No long-term commitment</div>
          ...
          <div style={{ border: `1.5px solid rgba(45,212,191,.35)`, borderRadius: "1.25rem",
            ...
            <div style={{ fontSize: "1.35rem", fontWeight: 900, color: CYAN,
              letterSpacing: "-.03em", lineHeight: 1, marginBottom: ".2rem" }}>Monthly Platform Fee</div>
            <div style={{ fontSize: ".82rem", color: "#64748b" }}>Volume tiered per claim rate · Scales as you grow</div>
            ...
            <CI>Rate decreases automatically as monthly claim volume scales</CI>
            <CI>No renegotiation required — discounts apply at each threshold</CI>
            <CI>Custom high-volume rates available on request</CI>
        ...
        {/* CTA */}
        <div className="rv td2" style={{ textAlign: "center", marginBottom: ".875rem" }}>
          <a href={CALENDLY} target="_blank" rel="noopener noreferrer" className="bp"
      ...
      <div ref={ref} style={{ maxWidth: 780, margin: "0 auto", padding: "0 2rem" }}>
        <div className="rv" style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <h2 style={{ fontSize: "clamp(1.7rem, 3.5vw, 2.5rem)", fontWeight: 800,
            ...
            See what legacy processing is costing you.
          </h2>
        ...
        <div className="rv td1" style={{ background: S900,
          ...
          {/* Result cards - legacy + savings message */}
          <div className="rg" style={{ display: "grid",
            gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.5rem" }}>

            {/* Legacy cost */}
            <div style={{ background: "rgba(239,68,68,.07)", border: "1px solid rgba(239,68,68,.2)",
              borderRadius: ".875rem", padding: "1.25rem", textAlign: "center" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center",
                gap: ".35rem", marginBottom: ".4rem" }}>
                <span style={{ fontSize: ".58rem", color: "#ef4444", fontWeight: 700, letterSpacing: ".08em" }}>LEGACY COST</span>
                <div style={{ position: "relative", display: "inline-flex" }}
                  onMouseEnter={() => setTipVisible(true)}
                  onMouseLeave={() => setTipVisible(false)}>
                  <span style={{ width: 14, height: 14, borderRadius: "50%",
                    border: "1px solid #ef4444", color: "#ef4444", fontSize: ".52rem",
                    fontWeight: 700, display: "inline-flex", alignItems: "center",
                    justifyContent: "center", cursor: "default", opacity: .75, lineHeight: 1 }}>i</span>
                  {tipVisible && (
              ...
              <div style={{ fontSize: "clamp(1.2rem, 3.5vw, 1.7rem)", fontWeight: 900,
                color: "#ef4444", letterSpacing: "-.04em", lineHeight: 1 }}>{fmt(legacyTotal)}</div>
              <div style={{ fontSize: ".68rem", color: "#94a3b8", marginTop: ".3rem" }}>est. per month</div>
            </div>

            {/* Sondar savings message */}
            <div style={{ background: "rgba(45,212,191,.06)", border: "1px solid rgba(45,212,191,.2)",
              borderRadius: ".875rem", padding: "1.25rem", textAlign: "center",
              display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
              <div style={{ fontSize: ".58rem", color: CYAN, fontWeight: 700,
                letterSpacing: ".08em", marginBottom: ".5rem" }}>WITH SONDAR</div>
              <div style={{ fontSize: "clamp(1.2rem, 3.5vw, 1.7rem)", fontWeight: 900,
                color: CYAN, letterSpacing: "-.04em", lineHeight: 1, marginBottom: ".3rem" }}>
                ~{pct}% less
              </div>
              <div style={{ fontSize: ".68rem", color: "#94a3b8", marginBottom: "1rem" }}>
                vs. legacy processing
              </div>
              <a href={CALENDLY} target="_blank" rel="noopener noreferrer" className="bp"
                style={{ fontSize: ".75rem", padding: ".5rem 1.1rem", display: "inline-flex" }}>
          ...
          <p style={{ textAlign: "center", color: "#94a3b8", fontSize: ".7rem", marginBottom: "1.25rem" }}>
            Legacy cost estimate based on industry standard manual processing rates. Actual costs vary by vendor and campaign complexity.
          </p>
    ...
    <section style={{ background: S950, padding: "5rem 0",
      ...
      <div ref={ref} style={{ maxWidth: 680, margin: "0 auto", padding: "0 2rem", position: "relative" }}>
        ...
        <p className="rv td2" style={{ color: "rgba(255,255,255,.45)", fontSize: "1rem",
          ...
          Put 65% of your admin budget back into marketing with Sondar Logic.
        </p>
...
function PrivacyPolicy({ onBack }) {
  return (
    <LegalPage title="Privacy Policy" effectiveDate="March 2026" onBack={onBack}>
      ...
      <p style={lbs}>Sondar Logic, headquartered in Burlington, Ontario, provides an automated rebate validation and payment processing platform. This Privacy Policy outlines how we collect, use, disclose, and safeguard personal information in compliance with PIPEDA and applicable provincial privacy legislation.</p>
      ...
      <p style={lbs}>Sondar Logic, Burlington, Ontario. Email: <a href="mailto:hello@sondarlogic.com" style={{ color: CYAN_D, textDecoration: "none" }}>hello@sondarlogic.com</a></p>
    </LegalPage>
  );
}
...
function TermsOfService({ onBack }) {
  return (
    <LegalPage title="Terms of Service" effectiveDate="March 2026" onBack={onBack}>
      ...
      <p style={lbs}>Sondar Logic provides an automated, proprietary receipt validation and rebate disbursement engine including automated fraud detection, deep basket data extraction, and API routing for digital payouts.</p>
      ...
      <p style={lbs}>Clients are billed a flat monthly platform license fee plus volume tiered pricing per claim. Sondar Logic does not charge exception fees on rejected claims. Clients must maintain sufficient payout funding with our Canada based secure payment partner.</p>
      <h2 style={lh2}>Proprietary Rights and Data Ownership</h2>
      <p style={lbs}>Sondar Logic retains all intellectual property rights to the platform and AI models. The Client retains all rights to their first-party consumer data and the basket intelligence provided via the platform.</p>
...
/* ─── ROOT ────────────────────────────────────────────────── */
export default function SondarLogic() {
